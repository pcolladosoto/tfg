\chapter{Automating the Deployment of Virtual Networks} \label{chap:4}
    ...
    \section{In-depth Module Analysis}
        ...
        \subsection{The \texttt{virt\_net} Module}
            \input{Code_doc/Constants.tex}
            \input{Code_doc/Interface.tex}
            \input{Code_doc/Subnet_machines.tex}
            \input{Code_doc/Subnet.tex}
            \input{Code_doc/Veth.tex}
            \input{Code_doc/Net_machines.tex}
            \input{Code_doc/Net.tex}
            \input{Code_doc/Address_manager.tex}
        ...
        \subsection{The \texttt{graph\_interpreter} Module}
            ...
            \input{Code_doc/Graph_interpreter.tex}
