...
\begin{document}
    ...
    % Document Body
        ...
        \input{Content/Chapters/Ch_2.tex}
        \input{Content/Chapters/Ch_3.tex}
        \input{Content/Chapters/Ch_4.tex}
        \input{Content/Chapters/Ch_5.tex}
        \input{Content/Chapters/Ch_6.tex}

    % Appendixes
        % No kidding: https://dictionary.cambridge.org/dictionary/english/appendix)
        \appendix
        \input{Content/Appendixes/Planning_and_budget.tex}
        \input{Content/Appendixes/System_setup.tex}
        \input{Content/Appendixes/Module_analysis.tex}
